#!/usr/bin/env python3
# to run
# /usr/bin/time -o /directflow/SCCGGroupShare/projects/anncuo/OneK1K/saige_eqtl/cellregmap_comparison/logs/RPL23A.cis.chr17.cellregmap.logs.txt -v /share/ScratchGeneral/anncuo/jupyter/conda_notebooks/envs/cellregmap_notebook/bin/python cellregmap_interaction_runner.py /directflow/SCCGGroupShare/projects/anncuo/OneK1K/saige_eqtl/cellregmap_comparison/input_files/RPL23A.cis.chr17.input.txt /directflow/SCCGGroupShare/projects/anncuo/OneK1K/saige_eqtl/cellregmap_comparison/pvals/
# runner at (local copy of): https://github.com/annacuomo/SAIGE_QTL_analyses/other_tools_comparison/run_cellregmap_inter.qsub

"""
Runs CellRegMap's interaction test for a given gene

Input: 
combined input file including gene expression,
covariates, genotypes (cis SNPs), individual id

Output:
data frame with p-values for all SNPs tested
saved in the provided output directory
"""
